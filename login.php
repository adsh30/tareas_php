...
<div class="login-box">
  ...
  <div class="mb-4 text-center">
							<img src="assets/logos/logo-empresa.png" width="200" alt="" />
						</div>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <form action="" id="login-form">
        ...
        <div class="row">
          ...
          <a class="btn btn-dark btn-block" title="click para ingresar" type="submit" href="registrar_asistencia.php" style="padding: 10px; margin-top: 10px;">Registrar Asistencia</a>
</div>
          <!-- /.col -->
        </div>
      </form>

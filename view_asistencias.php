...
$designation= $conn->query("SELECT * FROM asistencia where id = $designation_id ");
$designation = $designation->num_rows > 0 ? $designation->fetch_array()['entrada'] : 'Entrada NO Registrada';
$department= $conn->query("SELECT * FROM asistencia where id = $department_id ");
$department = $department->num_rows > 0 ? $department->fetch_array()['salida'] : 'Salida NO Registrada';

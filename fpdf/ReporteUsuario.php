...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, utf8_decode('NOMBRE EMPLEADO'), 1, 0, 'C', 1);
      $this->Cell(75, 10, utf8_decode('CORREO'), 1, 1, 'C', 1);
   }
...
$consulta_reporte_usuario = $conn->query(" SELECT * from users ");
...
while ($datos_reporte = $consulta_reporte_usuario->fetch_object()) {
   ...
   $pdf->Cell(75, 10, utf8_decode($datos_reporte->email), 1, 1, 'C', 0);
}

...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(60, 10, utf8_decode('CARGO'), 1, 1, 'C', 1);
   }
...
$consulta_reporte_empleado = $conn->query(" SELECT employee_list.firstname,
employee_list.lastname,
employee_list.cedula,
employee_list.email,
designation_list.designation AS 'nomCargo' FROM employee_list INNER JOIN designation_list ON designation_list.id = employee_list.designation_id ");
...
while ($datos_reporte = $consulta_reporte_empleado->fetch_object()) {
   ...
   $pdf->Cell(60, 10, utf8_decode($datos_reporte->nomCargo), 1, 1, 'C', 0);
}
